            ...
            return function (action) {
                return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Effect_Aff_Class.liftAff(dictMonadAff)(Effect_Aff_AVar.take($$var)))(function (v) {
                    ...
                    if (v instanceof MEmpty) {
                        return Control_Bind.bind(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Control_Monad_Error_Class["try"](dictMonadError)(action))(function (v1) {
                            return Control_Bind.discard(Control_Bind.discardUnit)(((dictMonadAff.MonadEffect0()).Monad0()).Bind1())(Effect_Aff_Class.liftAff(dictMonadAff)(Effect_Aff_AVar.put(Data_Either.either(MFailed.create)(MMemoized.create)(v1))($$var)))(function () {
                                return Data_Either.either(Control_Monad_Error_Class.throwError(dictMonadError.MonadThrow0()))(Control_Applicative.pure(((dictMonadAff.MonadEffect0()).Monad0()).Applicative0()))(v1);
                            });
                        });
                    };
    ...
    return function (g) {
        return function (f) {
            return Data_Newtype.over(newtypeSpecT)(newtypeSpecT)(SpecT)(Control_Monad_Writer_Trans.mapWriterT((function () {
                var $87 = Data_Functor.map(dictFunctor)(Data_Functor.map(Data_Tuple.functorTuple)(Data_Functor.map(Data_Functor.functorArray)(f)));
                return function ($88) {
                    return $87(g($88));
                };
            })()));
        ...
        return function (f) {
            var onTest = function (name) {
                return Data_Newtype.over(Test_Spec_Tree.itemNewtype)(Test_Spec_Tree.itemNewtype)(Test_Spec_Tree.Item)(function (item) {
                    var e = function (g) {
                        return g((function () {
                            var $89 = f(new TestWithName(name));
                            return function ($90) {
                                return $89(item.example(Data_Function.applyFlipped($90)));
                            };
                        })());
                    };
                    return {
...
var focus = function (dictFocusWarning) {
    return function (dictMonad) {
        return Data_Newtype.over(newtypeSpecT)(newtypeSpecT)(SpecT)(Control_Monad_Writer_Trans.mapWriterT(Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(Data_Functor.map(Data_Tuple.functorTuple)(function (xs) {
            var $83 = Data_Foldable.any(Data_Foldable.foldableArray)(Data_HeytingAlgebra.heytingAlgebraBoolean)(Data_Foldable.any(Test_Spec_Tree.treeFoldable)(Data_HeytingAlgebra.heytingAlgebraBoolean)((function () {
                var $91 = Data_Newtype.un(Test_Spec_Tree.itemNewtype)(Test_Spec_Tree.Item);
                return function ($92) {
                    return (function (v) {
                        return v.isFocused;
                    })($91($92));
...
var itOnly = function (dictFocusWarning) {
    return function (dictMonad) {
        return function (dictExample) {
            var $93 = Data_Functor.map(Data_Functor.functorFn)(focus()(dictMonad));
            var $94 = it(dictMonad)(dictExample);
            return function ($95) {
                return $93($94($95));
            };
        };
...
var describeOnly = function (dictFocusWarning) {
    return function (dictMonad) {
        var $96 = Data_Functor.map(Data_Functor.functorFn)(focus()(dictMonad));
        var $97 = describe(dictMonad);
        return function ($98) {
            return $96($97($98));
        };
    };
...
var collect = function (dictFunctor) {
    var $99 = Data_Functor.map(dictFunctor)(Test_Spec_Tree.discardUnfocused);
    var $100 = Control_Monad_Writer_Trans.execWriterT(dictFunctor);
    var $101 = Data_Newtype.un(newtypeSpecT)(SpecT);
    return function ($102) {
        ...
        return function (dictMonadError) {
            return function (action) {
                return function (spec) {
                    return Control_Bind.bind(bindSpecT((dictMonadEffect.Monad0()).Bind1()))(Effect_Class.liftEffect(monadEffectWriter(dictMonadEffect))(Effect_AVar["new"](MEmpty.value)))(function (v) {
                        return before_(dictMonadEffect.Monad0())((dictMonadAff.MonadEffect0()).Monad0())(memoize(dictMonadAff)(dictMonadError)(v)(action))(spec);
                    });
                };
            };
        };
    ...
    return function (dictMonadAff) {
        return function (dictMonadError) {
            return function (action) {
                return function (spec) {
                    return Control_Bind.bind(bindSpecT((dictMonadEffect.Monad0()).Bind1()))(Effect_Class.liftEffect(monadEffectWriter(dictMonadEffect))(Effect_AVar["new"](MEmpty.value)))(function (v) {
                        return before(dictMonadEffect.Monad0())((dictMonadAff.MonadEffect0()).Monad0())(memoize(dictMonadAff)(dictMonadError)(v)(action))(spec);
                    });
                };
            };
        };
