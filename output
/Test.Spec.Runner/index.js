...
var mergeProducers = function (dictTraversable) {
    return function (ps) {
        return Control_Bind.bind(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(Effect_Aff.monadAff)(Effect_Aff_AVar.empty))(function (v) {
            return Control_Bind.bind(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(Effect_Aff.monadAff)(Effect_Aff.forkAff((function () {
                var consumer = function (i) {
                    return Control_Apply.applySecond(Pipes_Internal.applyProxy(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(Effect_Aff.monadAff)(Effect_Aff_AVar.put(i)(v)))(Control_Applicative.pure(Pipes_Internal.applicativeProxy(Effect_Aff.monadAff))(Data_Unit.unit));
                };
                return Control_Bind.bind(Effect_Aff.bindAff)(Control_Parallel.parTraverse(Effect_Aff.parallelAff)(dictTraversable)(function (p) {
                    ...
                    return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Aff_AVar.kill(Effect_Exception.error("finished"))(v))(function () {
                        return Control_Applicative.pure(Effect_Aff.applicativeAff)(v1);
                    });
                });
            })())))(function (v1) {
                var loop = Control_Bind.bind(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(Effect_Aff.monadAff)(Control_Monad_Error_Class["try"](Effect_Aff.monadErrorAff)(Effect_Aff_AVar.take(v))))(function (v2) {
                    if (v2 instanceof Data_Either.Left) {
                        return Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(Effect_Aff.monadAff)(Effect_Aff.joinFiber(v1));
                    };
                    if (v2 instanceof Data_Either.Right) {
                        return Control_Bind.discard(Control_Bind.discardUnit)(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Pipes["yield"](Effect_Aff.monadAff)(v2.value0))(function () {
                            return loop;
                        });
                    };
                    throw new Error("Failed pattern match at Test.Spec.Runner (line 153, column 7 - line 157, column 15): " + [ v2.constructor.name ]);
                });
                return loop;
            });
        });
...
var _run = function (dictFunctor) {
    return function (config) {
        var runGroup = function (v) {
            if (v.test instanceof Test_Spec_Tree.Leaf && v.test.value1 instanceof Data_Maybe.Just) {
                return Control_Bind.discard(Control_Bind.discardUnit)(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Pipes["yield"](Effect_Aff.monadAff)(new Test_Spec_Runner_Event.Test((function () {
                    ...
                    return Control_Bind.bind(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(Effect_Aff.monadAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Effect_Now.now)))(function (v1) {
                        return Control_Bind.bind(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(Effect_Aff.monadAff)(Effect_Aff.attempt((function () {
                            ...
                            return Control_Bind.bind(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Effect_Class.liftEffect(Pipes_Internal.proxyMonadEffect(Effect_Aff.monadEffectAff))(Effect_Now.now))(function (v3) {
                                var duration = Data_Time_Duration.Milliseconds(Data_Function.on(Data_Ring.sub(Data_Ring.ringNumber))((function () {
                                    var $59 = Data_Newtype.un(Data_Time_Duration.newtypeMilliseconds)(Data_Time_Duration.Milliseconds);
                                    return function ($60) {
                                        return $59(Data_DateTime_Instant.unInstant($60));
                                    };
                                })())(v3)(v1));
                                var res = Data_Either.either(Test_Spec_Result.Failure.create)(Data_Function["const"](new Test_Spec_Result.Success(Test_Spec_Speed.speedOf(config.slow)(duration), duration)))(v2);
            ...
            if (v.test instanceof Test_Spec_Tree.Node && v.test.value0 instanceof Data_Either.Left) {
                return Control_Bind.discard(Control_Bind.discardUnit)(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Pipes["yield"](Effect_Aff.monadAff)(new Test_Spec_Runner_Event.Suite((function () {
                    ...
                    return Control_Bind.bind(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(loop(Data_Array.mapWithIndex(indexer)(v.test.value1)))(function (v1) {
                        return Control_Bind.discard(Control_Bind.discardUnit)(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Pipes["yield"](Effect_Aff.monadAff)(new Test_Spec_Runner_Event.SuiteEnd(v.path)))(function () {
                            return Control_Applicative.pure(Pipes_Internal.applicativeProxy(Effect_Aff.monadAff))([ new Test_Spec_Tree.Node(new Data_Either.Left(v.test.value0.value0), v1) ]);
                        });
                    });
                });
            };
            throw new Error("Failed pattern match at Test.Spec.Runner (line 113, column 47 - line 137, column 38): " + [ v.test.constructor.name ]);
        };
        var loop = function (tests) {
            ...
            return Data_Functor.map(Pipes_Internal.functorProxy(Effect_Aff.monadAff))(Control_Bind.join(Control_Bind.bindArray))(Data_Traversable["for"](Pipes_Internal.applicativeProxy(Effect_Aff.monadAff))(Data_Traversable.traversableArray)(groupByIsParallelizable(noteWithIsAllParallelizable(tests)))(function (g) {
                return Data_Functor.map(Pipes_Internal.functorProxy(Effect_Aff.monadAff))(Control_Bind.join(Control_Bind.bindArray))((function () {
                    var $52 = (Data_Array_NonEmpty.head(g)).isParallelizable;
                    if ($52) {
        ...
        var $61 = Data_Functor.map(dictFunctor)(function (tests) {
            return Control_Bind.discard(Control_Bind.discardUnit)(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(Pipes["yield"](Effect_Aff.monadAff)(new Test_Spec_Runner_Event.Start(Test_Spec_Tree.countTests(tests))))(function () {
                ...
                return Control_Bind.bind(Pipes_Internal.bindProxy(Effect_Aff.monadAff))(loop(Data_Array.mapWithIndex(indexer)(tests)))(function (v) {
        ...
        var $62 = Test_Spec.collect(dictFunctor);
        return function ($63) {
            return $61($62($63));
        };
    };
                        ...
                        return Control_Bind.bind(Effect_Aff.bindAff)(Control_Monad_Error_Class["try"](Effect_Aff.monadErrorAff)(reportedEvents))(function (v) {
                            ...
                            if (v instanceof Data_Either.Right) {
                                return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)((function () {
                                    var code = (function () {
                                        var $57 = Test_Spec_Summary.successful(v.value0);
                                        if ($57) {
                                            return 0;
                                        };
                                        return 1;
                            ...
                            throw new Error("Failed pattern match at Test.Spec.Runner (line 181, column 33 - line 189, column 21): " + [ v.constructor.name ]);
                        });
                    };
...
var run = function (dictWarn) {
    return function (reporters) {
        return function (spec) {
            return Data_Functor["void"](Effect_Aff.functorAff)(Data_Newtype.un(Data_Identity.newtypeIdentity)(Data_Identity.Identity)(runSpecT(Data_Identity.functorIdentity)(defaultConfig)(reporters)(spec)));
        };
    };
};
