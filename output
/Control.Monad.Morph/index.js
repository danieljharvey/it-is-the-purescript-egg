        ...
        return function (m) {
            return Control_Bind.bind(dictMonad.Bind1())(Control_Monad_Maybe_Trans.runMaybeT(f(Control_Monad_Maybe_Trans.runMaybeT(m))))(function (v) {
                return Control_Applicative.pure(dictMonad.Applicative0())((function () {
                    ...
                    throw new Error("Failed pattern match at Control.Monad.Morph (line 130, column 10 - line 133, column 30): " + [ v.constructor.name ]);
                })());
            });
        };
    };
        ...
        return function (m) {
            return Control_Bind.bind(dictMonad.Bind1())(Control_Monad_Except_Trans.runExceptT(f(Control_Monad_Except_Trans.runExceptT(m))))(function (v) {
                return Control_Applicative.pure(dictMonad.Applicative0())((function () {
                    ...
                    throw new Error("Failed pattern match at Control.Monad.Morph (line 122, column 10 - line 125, column 33): " + [ v.constructor.name ]);
                })());
            });
        };
    };
...
var generalize = function (dictMonad) {
    var $60 = Control_Applicative.pure(dictMonad.Applicative0());
    var $61 = Data_Newtype.unwrap(Data_Identity.newtypeIdentity);
    return function ($62) {
        return $60($61($62));
    };
};
