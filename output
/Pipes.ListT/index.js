...
var maybeTEnumerable = new Enumerable(function (dictMonad) {
    return function (m) {
        return Select(Control_Bind.bind(Pipes_Internal.bindProxy(dictMonad))(Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(dictMonad)(Control_Monad_Maybe_Trans.runMaybeT(m)))(function (v) {
            ...
            throw new Error("Failed pattern match at Pipes.ListT (line 122, column 9 - line 124, column 31): " + [ v.constructor.name ]);
        }));
    };
});
...
var errorTEnumerable = new Enumerable(function (dictMonad) {
    return function (m) {
        return Select(Control_Bind.bind(Pipes_Internal.bindProxy(dictMonad))(Control_Monad_Trans_Class.lift(Pipes_Internal.monadTransProxy)(dictMonad)(Control_Monad_Except_Trans.runExceptT(m)))(function (v) {
            ...
            throw new Error("Failed pattern match at Pipes.ListT (line 129, column 9 - line 131, column 31): " + [ v.constructor.name ]);
        }));
    };
});
...
var listTBind = function (dictMonad) {
    return new Control_Bind.Bind(function () {
        ...
        return function (f) {
            return Pipes["for"](dictMonad)(v)(function ($96) {
                return enumerate(f($96));
            });
        };
    });
};
...
var listTMonadEffect = function (dictMonadEffect) {
    return new Effect_Class.MonadEffect(function () {
        ...
        var $97 = Control_Monad_Trans_Class.lift(listTMonadTrans)(dictMonadEffect.Monad0());
...
var listTMonadState = function (dictMonadState) {
    return new Control_Monad_State_Class.MonadState(function () {
        ...
        var $100 = Control_Monad_Trans_Class.lift(listTMonadTrans)(dictMonadState.Monad0());
...
var listTMonadTell = function (dictMonoid) {
    return function (dictMonadTell) {
        return new Control_Monad_Writer_Class.MonadTell(function () {
            ...
            var $103 = Control_Monad_Trans_Class.lift(listTMonadTrans)(dictMonadTell.Monad0());
            var $104 = Control_Monad_Writer_Class.tell(dictMonadTell);
            return function ($105) {
                return $103($104($105));
            };
        })());
...
var listTMonadThrow = function (dictMonadThrow) {
    return new Control_Monad_Error_Class.MonadThrow(function () {
        ...
        var $106 = Control_Monad_Trans_Class.lift(listTMonadTrans)(dictMonadThrow.Monad0());
        var $107 = Control_Monad_Error_Class.throwError(dictMonadThrow);
        return function ($108) {
            return $106($107($108));
        };
    })());
...
var listTMonadError = function (dictMonadError) {
    return new Control_Monad_Error_Class.MonadError(function () {
        ...
        return function (f) {
            return Control_Monad_Error_Class.catchError(Pipes_Internal.proxyMonadError(dictMonadError))(v)(function ($109) {
                return enumerate(f($109));
            });
        };
    });
};
