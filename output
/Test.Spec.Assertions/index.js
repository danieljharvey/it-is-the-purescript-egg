...
var fail = function (dictMonadThrow) {
    var $35 = Control_Monad_Error_Class.throwError(dictMonadThrow);
    return function ($36) {
        return $35(Effect_Exception.error($36));
    };
};
...
var expectError = function (dictMonadError) {
    return function (a) {
        return Control_Bind.bind(((dictMonadError.MonadThrow0()).Monad0()).Bind1())(Control_Monad_Error_Class["try"](dictMonadError)(a))(function (v) {
            ...
            throw new Error("Failed pattern match at Test.Spec.Assertions (line 105, column 3 - line 107, column 51): " + [ v.constructor.name ]);
        });
    };
};
module.exports = {
