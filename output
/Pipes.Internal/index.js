        ...
        var go = function (p) {
            ...
            if (p instanceof Respond) {
                return Control_Applicative.pure(dictMonad.Applicative0())(new Respond(p.value0, (function () {
                    var $147 = observe(dictMonad);
                    return function ($148) {
                        return $147(p.value1($148));
                    };
                })()));
            };
            if (p instanceof M) {
...
var proxyMonadState = function (dictMonadState) {
    return new Control_Monad_State_Class.MonadState(function () {
        ...
        var $149 = Control_Monad_Trans_Class.lift(monadTransProxy)(dictMonadState.Monad0());
        var $150 = Control_Monad_State_Class.state(dictMonadState);
        return function ($151) {
            return $149($150($151));
        };
    })());
...
var proxyMonadTell = function (dictMonoid) {
    return function (dictMonadTell) {
        return new Control_Monad_Writer_Class.MonadTell(function () {
            ...
            var $152 = Control_Monad_Trans_Class.lift(monadTransProxy)(dictMonadTell.Monad0());
            var $153 = Control_Monad_Writer_Class.tell(dictMonadTell);
            return function ($154) {
                return $152($153($154));
            };
        })());
...
var proxyMonadThrow = function (dictMonadThrow) {
    return new Control_Monad_Error_Class.MonadThrow(function () {
        ...
        var $155 = Control_Monad_Trans_Class.lift(monadTransProxy)(dictMonadThrow.Monad0());
        var $156 = Control_Monad_Error_Class.throwError(dictMonadThrow);
        return function ($157) {
            return $155($156($157));
        };
    })());
        ...
        return function (f) {
            ...
            if (v instanceof M) {
                return new M(Control_Monad_Error_Class.catchError(dictMonadError)(Control_Bind.bind(((dictMonadError.MonadThrow0()).Monad0()).Bind1())(v.value0)(function (v1) {
                    ...
                    var $158 = Control_Applicative.pure(((dictMonadError.MonadThrow0()).Monad0()).Applicative0());
                    return function ($159) {
                        return $158(f($159));
                    };
                })()));
